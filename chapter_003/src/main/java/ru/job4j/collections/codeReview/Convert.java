...
public class Convert {
    ...
    public Convert(){ // конструктор без входных параметров можно не указывать(вызовется по умолчанию)
    ...
    // много пустых строк, пустые строки (обычно одну) добавляют для лучшей читабельности и если нужно выделить какой то
    // блок кода
